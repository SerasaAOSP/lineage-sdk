...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.serasa.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.serasa.display.version");
    ...
    public static class LINEAGE_VERSION {
        ...
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.serasa.build.version.plat.sdk", 0);
    }
